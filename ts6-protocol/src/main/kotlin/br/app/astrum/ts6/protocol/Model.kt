...
data class Ts3Channel(
    ...
    val codecLatencyFactor: Int = 0,
    val maxClients: Int = 0,
    val maxFamilyClients: Int = 0,
    val isPermanent: Boolean = false,
    val isSemiPermanent: Boolean = false,
    val maxClientsUnlimited: Boolean = false,
    val maxFamilyClientsUnlimited: Boolean = false,
    val areSubscribed: Boolean = false,
    val unsubscribable: Boolean = false,
    val neededTalkPower: Int = 0,
    val iconId: Long = 0L,
    val secondsEmpty: Long = 0L,
    val bannerGfxUrl: String = "",
    val bannerMode: Int = 0,
)
